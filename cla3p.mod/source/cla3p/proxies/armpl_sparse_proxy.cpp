...
static void armpl_sparse_create_dns(armpl_spmat_t* mat, int_t m, int_t n, const T_Scl *a, int_t lda) \
{ \
...
static void armpl_sparse_create_csc(armpl_spmat_t* mat, int_t m, int_t n, const int_t *colptr, const int_t *rowidx, const T_Scl *values) \
{ \
...
static void armpl_sparse_create_csr(armpl_spmat_t* mat, int_t m, int_t n, const int_t *rowptr, const int_t *colidx, const T_Scl *values) \
{ \
...
class DnsMatrix : public ArmPlMatrix {
	...
	public:
		...
		DnsMatrix(int_t m, int_t n, const T_Scalar *a, int_t lda)
		{
			armpl_sparse_create_dns(&mat(), m, n, a, lda);
		}

		void exportd(T_Scalar *c, int_t ldc)
		{
			// This is stupid...
			int_t m = 0;
			int_t n = 0;
		...
		void exportd(int_t *m, int_t *n, T_Scalar *c, int_t ldc)
		{
			// This is stupid...
			T_Scalar *res = nullptr;
			armpl_sparse_export_dns(mat(), m, n, &res);
...
class CsrMatrix : public CsxMatrix {
	...
	public:
		...
		CsrMatrix(int_t m, int_t n) : CsxMatrix(m, n) {}

		CsrMatrix(int_t m, int_t n, const int_t *rowptr, const int_t *colidx, const T_Scalar *values)
		{
...
class CscMatrix : public CsxMatrix {
	...
	public:
		...
		CscMatrix(int_t m, int_t n) : CsxMatrix(m, n) {}

		CscMatrix(int_t m, int_t n, const int_t *colptr, const int_t *rowidx, const T_Scalar *values)
		{
...
template void csc_add(int_t, int_t, \
		...
		int_t k, const T_Scalar* b, int_t ldb, T_Scalar beta, T_Scalar *c, int_t ldc)
{
	...
	int_t mB = (opA == op_t::N ? n : m);                   
	int_t mC = (opA == op_t::N ? m : n);               
