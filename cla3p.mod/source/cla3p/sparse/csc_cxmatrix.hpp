 ...
 * @details Represents a sparse complex-valued matrix in compressed sparse column (CSC) format.
...
class CxMatrix : public XxMatrix<T_Int,T_Scalar> {
    ...
    public:
        ...
        CxMatrix(const alias::VirtualExpr_csc<T_Int,T_Scalar,T_Virtual>& v) : XxMatrix<T_Int,T_Scalar>(v) {}
        template <typename T_Virtual>
        CxMatrix<T_Int,T_Scalar>& operator=(const alias::VirtualExpr_csc<T_Int,T_Scalar,T_Virtual>& v) { XxMatrix<T_Int,T_Scalar>::operator=(v); return *this; }
         ...
         * @details Creates a complex sparse matrix of the specified dimensions in CSC format and allocates memory.
         ...
         * @details Creates a complex sparse matrix using existing CSC format arrays.
         * @param[in] nr The number of rows.
         * @param[in] nc The number of columns.
         ...
         * @param[in] pr The matrix property (default: General).
         */
        explicit CxMatrix(T_Int nr, T_Int nc, T_Int *cptr, T_Int *ridx, T_Scalar *vals, bool bind, const Property& pr = Property::General());
