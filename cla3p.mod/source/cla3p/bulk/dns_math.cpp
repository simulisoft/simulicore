...
template void update(uplo_t, int_t, int_t, real4_t   , const real4_t   *, int_t, real4_t   *, int_t);
template void update(uplo_t, int_t, int_t, complex_t , const complex_t *, int_t, complex_t *, int_t);
template void update(uplo_t, int_t, int_t, complex8_t, const complex8_t*, int_t, complex8_t*, int_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
/*-------------------------------------------------*/
template void add(uplo_t, int_t, int_t, real_t    , const real_t    *, int_t, real_t    , const real_t    *, int_t, real_t    *, int_t);
template void add(uplo_t, int_t, int_t, real4_t   , const real4_t   *, int_t, real4_t   , const real4_t   *, int_t, real4_t   *, int_t);
template void add(uplo_t, int_t, int_t, complex_t , const complex_t *, int_t, complex_t , const complex_t *, int_t, complex_t *, int_t);
template void add(uplo_t, int_t, int_t, complex8_t, const complex8_t*, int_t, complex8_t, const complex8_t*, int_t, complex8_t*, int_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template void gem_x_vec(op_t, int_t, int_t, real4_t   , const real4_t   *, int_t, const real4_t   *, real4_t   , real4_t   *);
template void gem_x_vec(op_t, int_t, int_t, complex_t , const complex_t *, int_t, const complex_t *, complex_t , complex_t *);
template void gem_x_vec(op_t, int_t, int_t, complex8_t, const complex8_t*, int_t, const complex8_t*, complex8_t, complex8_t*);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template void sym_x_vec(uplo_t, int_t, real4_t   , const real4_t   *, int_t, const real4_t   *, real4_t   , real4_t   *);
template void sym_x_vec(uplo_t, int_t, complex_t , const complex_t *, int_t, const complex_t *, complex_t , complex_t *);
template void sym_x_vec(uplo_t, int_t, complex8_t, const complex8_t*, int_t, const complex8_t*, complex8_t, complex8_t*);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
...
template void hem_x_vec(uplo_t, int_t, complex8_t, const complex8_t*, int_t, const complex8_t*, complex8_t, complex8_t*);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template void trm_x_vec(uplo_t, op_t, int_t, int_t, real4_t   , const real4_t   *, int_t, const real4_t   *, real4_t   *);
template void trm_x_vec(uplo_t, op_t, int_t, int_t, complex_t , const complex_t *, int_t, const complex_t *, complex_t *);
template void trm_x_vec(uplo_t, op_t, int_t, int_t, complex8_t, const complex8_t*, int_t, const complex8_t*, complex8_t*);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template void gem_x_gem(int_t, int_t, int_t, real4_t   , op_t, const real4_t   *, int_t, op_t, const real4_t   *, int_t, real4_t   , real4_t   *, int_t);
template void gem_x_gem(int_t, int_t, int_t, complex_t , op_t, const complex_t *, int_t, op_t, const complex_t *, int_t, complex_t , complex_t *, int_t);
template void gem_x_gem(int_t, int_t, int_t, complex8_t, op_t, const complex8_t*, int_t, op_t, const complex8_t*, int_t, complex8_t, complex8_t*, int_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template void sym_x_gem(uplo_t, int_t, int_t, real4_t   , const real4_t   *, int_t, const real4_t   *, int_t, real4_t   , real4_t   *, int_t);
template void sym_x_gem(uplo_t, int_t, int_t, complex_t , const complex_t *, int_t, const complex_t *, int_t, complex_t , complex_t *, int_t);
template void sym_x_gem(uplo_t, int_t, int_t, complex8_t, const complex8_t*, int_t, const complex8_t*, int_t, complex8_t, complex8_t*, int_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template void gem_x_sym(uplo_t, int_t, int_t, real4_t   , const real4_t   *, int_t, const real4_t   *, int_t, real4_t   , real4_t   *, int_t);
template void gem_x_sym(uplo_t, int_t, int_t, complex_t , const complex_t *, int_t, const complex_t *, int_t, complex_t , complex_t *, int_t);
template void gem_x_sym(uplo_t, int_t, int_t, complex8_t, const complex8_t*, int_t, const complex8_t*, int_t, complex8_t, complex8_t*, int_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
...
template void hem_x_gem(uplo_t, int_t, int_t, complex8_t, const complex8_t*, int_t, const complex8_t*, int_t, complex8_t, complex8_t*, int_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
...
template void gem_x_hem(uplo_t, int_t, int_t, complex8_t, const complex8_t*, int_t, const complex8_t*, int_t, complex8_t, complex8_t*, int_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template void trm_x_gem(uplo_t, op_t, int_t, int_t, int_t, real4_t   , const real4_t   *, int_t, const real4_t   *, int_t, real4_t   *, int_t);
template void trm_x_gem(uplo_t, op_t, int_t, int_t, int_t, complex_t , const complex_t *, int_t, const complex_t *, int_t, complex_t *, int_t);
template void trm_x_gem(uplo_t, op_t, int_t, int_t, int_t, complex8_t, const complex8_t*, int_t, const complex8_t*, int_t, complex8_t*, int_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template void gem_x_trm(uplo_t, op_t, int_t, int_t, int_t, real4_t   , const real4_t   *, int_t, const real4_t   *, int_t, real4_t   *, int_t);
template void gem_x_trm(uplo_t, op_t, int_t, int_t, int_t, complex_t , const complex_t *, int_t, const complex_t *, int_t, complex_t *, int_t);
template void gem_x_trm(uplo_t, op_t, int_t, int_t, int_t, complex8_t, const complex8_t*, int_t, const complex8_t*, int_t, complex8_t*, int_t);
/*-------------------------------------------------*/
} // namespace dns
} // namespace blk
} // namespace cla3p
