...
template void set_diag_zeros(prop_t, int_t, real_t    *, int_t);
template void set_diag_zeros(prop_t, int_t, real4_t   *, int_t);
template void set_diag_zeros(prop_t, int_t, complex_t *, int_t);
template void set_diag_zeros(prop_t, int_t, complex8_t*, int_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template <> void fill(uplo_t uplo, int_t m, int_t n, real_t     *a, int_t lda, real_t     val){ fill_lapack(uplo, m, n, a, lda, val, val); }
template <> void fill(uplo_t uplo, int_t m, int_t n, real4_t    *a, int_t lda, real4_t    val){ fill_lapack(uplo, m, n, a, lda, val, val); }
template <> void fill(uplo_t uplo, int_t m, int_t n, complex_t  *a, int_t lda, complex_t  val){ fill_lapack(uplo, m, n, a, lda, val, val); }
template <> void fill(uplo_t uplo, int_t m, int_t n, complex8_t *a, int_t lda, complex8_t val){ fill_lapack(uplo, m, n, a, lda, val, val); }
/*-------------------------------------------------*/
template <> void fill(uplo_t uplo, int_t m, int_t n, int_t      *a, int_t lda, int_t      val, int_t      dval){ fill_std   (uplo, m, n, a, lda, val, dval); }
template <> void fill(uplo_t uplo, int_t m, int_t n, real_t     *a, int_t lda, real_t     val, real_t     dval){ fill_lapack(uplo, m, n, a, lda, val, dval); }
template <> void fill(uplo_t uplo, int_t m, int_t n, real4_t    *a, int_t lda, real4_t    val, real4_t    dval){ fill_lapack(uplo, m, n, a, lda, val, dval); }
...
template void rand(uplo_t, int_t, int_t, real_t    *, int_t, real_t , real_t );
template void rand(uplo_t, int_t, int_t, real4_t   *, int_t, real4_t, real4_t);
template void rand(uplo_t, int_t, int_t, complex_t *, int_t, real_t , real_t );
template void rand(uplo_t, int_t, int_t, complex8_t*, int_t, real4_t, real4_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
/*-------------------------------------------------*/
template <> void copy(uplo_t uplo, int_t m, int_t n, const real_t     *a, int_t lda, real_t     *b, int_t ldb, real_t     coeff) { copy_lapack(uplo, m, n, a, lda, b, ldb, coeff); }
template <> void copy(uplo_t uplo, int_t m, int_t n, const real4_t    *a, int_t lda, real4_t    *b, int_t ldb, real4_t    coeff) { copy_lapack(uplo, m, n, a, lda, b, ldb, coeff); }
...
/*-------------------------------------------------*/
template void get_real(uplo_t, int_t, int_t, const complex_t *, int_t, real_t *, int_t);
template void get_real(uplo_t, int_t, int_t, const complex8_t*, int_t, real4_t*, int_t);
/*-------------------------------------------------*/
template <typename T_Scalar>
...
/*-------------------------------------------------*/
template void set_real(uplo_t, int_t, int_t, const real_t *, int_t, complex_t *, int_t);
template void set_real(uplo_t, int_t, int_t, const real4_t*, int_t, complex8_t*, int_t);
/*-------------------------------------------------*/
template <typename T_Scalar>
...
/*-------------------------------------------------*/
template void get_imag(uplo_t, int_t, int_t, const complex_t *, int_t, real_t *, int_t);
template void get_imag(uplo_t, int_t, int_t, const complex8_t*, int_t, real4_t*, int_t);
/*-------------------------------------------------*/
template <typename T_Scalar>
...
/*-------------------------------------------------*/
template void set_imag(uplo_t, int_t, int_t, const real_t *, int_t, complex_t *, int_t);
template void set_imag(uplo_t, int_t, int_t, const real4_t*, int_t, complex8_t*, int_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template void scale(uplo_t, int_t, int_t, real4_t   *, int_t, real4_t   );
template void scale(uplo_t, int_t, int_t, complex_t *, int_t, complex_t );
template void scale(uplo_t, int_t, int_t, complex8_t*, int_t, complex8_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
/*-------------------------------------------------*/
template void transpose(int_t, int_t, const real_t    *, int_t, real_t    *, int_t, real_t    );
template void transpose(int_t, int_t, const real4_t   *, int_t, real4_t   *, int_t, real4_t   );
template void transpose(int_t, int_t, const complex_t *, int_t, complex_t *, int_t, complex_t );
template void transpose(int_t, int_t, const complex8_t*, int_t, complex8_t*, int_t, complex8_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
/*-------------------------------------------------*/
template void conjugate_transpose(int_t, int_t, const real_t    *, int_t, real_t    *, int_t, real_t    );
template void conjugate_transpose(int_t, int_t, const real4_t   *, int_t, real4_t   *, int_t, real4_t   );
template void conjugate_transpose(int_t, int_t, const complex_t *, int_t, complex_t *, int_t, complex_t );
template void conjugate_transpose(int_t, int_t, const complex8_t*, int_t, complex8_t*, int_t, complex8_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template <> void conjugate(uplo_t, int_t, int_t, real4_t*, int_t, real4_t) {}
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template void conjugate(uplo_t, int_t, int_t, complex8_t*, int_t, complex8_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template void sy2ge(uplo_t, int_t, real4_t   *, int_t);
template void sy2ge(uplo_t, int_t, complex_t *, int_t);
template void sy2ge(uplo_t, int_t, complex8_t*, int_t);
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template void he2ge(uplo_t, int_t, real4_t   *, int_t);
template void he2ge(uplo_t, int_t, complex_t *, int_t);
template void he2ge(uplo_t, int_t, complex8_t*, int_t);
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template void sk2ge(uplo_t, int_t, real4_t   *, int_t);
template void sk2ge(uplo_t, int_t, complex_t *, int_t);
template void sk2ge(uplo_t, int_t, complex8_t*, int_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template void tr2ge(uplo_t, int_t, int_t, real4_t   *, int_t);
template void tr2ge(uplo_t, int_t, int_t, complex_t *, int_t);
template void tr2ge(uplo_t, int_t, int_t, complex8_t*, int_t);
/*-------------------------------------------------*/
/*-------------------------------------------------*/
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template real4_t norm_one(prop_t, uplo_t, int_t, int_t, const real4_t   *, int_t);
template real_t  norm_one(prop_t, uplo_t, int_t, int_t, const complex_t *, int_t);
template real4_t norm_one(prop_t, uplo_t, int_t, int_t, const complex8_t*, int_t);
/*-------------------------------------------------*/
template <typename T_Scalar>
typename TypeTraits<T_Scalar>::real_type
...
template real4_t norm_inf(prop_t, uplo_t, int_t, int_t, const real4_t   *, int_t);
template real_t  norm_inf(prop_t, uplo_t, int_t, int_t, const complex_t *, int_t);
template real4_t norm_inf(prop_t, uplo_t, int_t, int_t, const complex8_t*, int_t);
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template real4_t norm_max(prop_t, uplo_t, int_t, int_t, const real4_t   *, int_t);
template real_t  norm_max(prop_t, uplo_t, int_t, int_t, const complex_t *, int_t);
template real4_t norm_max(prop_t, uplo_t, int_t, int_t, const complex8_t*, int_t);
/*-------------------------------------------------*/
//
// TODO: more efficient
//
...
template real4_t norm_fro(prop_t, uplo_t, int_t, int_t, const real4_t   *, int_t);
template real_t  norm_fro(prop_t, uplo_t, int_t, int_t, const complex_t *, int_t);
template real4_t norm_fro(prop_t, uplo_t, int_t, int_t, const complex8_t*, int_t);
/*-------------------------------------------------*/
template <typename T_Scalar>
...
template real4_t norm_euc(int_t, const real4_t   *);
template real_t  norm_euc(int_t, const complex_t *);
template real4_t norm_euc(int_t, const complex8_t*);
/*-------------------------------------------------*/
template <typename T_Scalar>
