...
namespace culite {
/*-------------------------------------------------*/
TypeTraits<real_t>::cla3p_type TypeTraits<real_t>::toHostType(const real_t v) { return cla3p_type(v); }
...
/*-------------------------------------------------*/
/*-------------------------------------------------*/
TypeTraits<real4_t>::cla3p_type TypeTraits<real4_t>::toHostType(const real4_t v) { return cla3p_type(v); }
...
/*-------------------------------------------------*/
/*-------------------------------------------------*/
TypeTraits<complex_t>::cla3p_type TypeTraits<complex_t>::toHostType(const complex_t v)
{ 
...
/*-------------------------------------------------*/
/*-------------------------------------------------*/
TypeTraits<complex8_t>::cla3p_type TypeTraits<complex8_t>::toHostType(const complex8_t v)
{ 
    return cla3p_type(arith::getRe(v), arith::getIm(v));
}
