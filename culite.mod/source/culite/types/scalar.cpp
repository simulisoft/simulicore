...
namespace culite {
/*-------------------------------------------------*/
TypeTraits<real_t>::cla3p_type TypeTraits<real_t>::toCla3pType(const real_t v) { return cla3p_type(v); }
...
/*-------------------------------------------------*/
/*-------------------------------------------------*/
TypeTraits<real4_t>::cla3p_type TypeTraits<real4_t>::toCla3pType(const real4_t v) { return cla3p_type(v); }
...
/*-------------------------------------------------*/
/*-------------------------------------------------*/
TypeTraits<complex_t>::cla3p_type TypeTraits<complex_t>::toCla3pType(const complex_t v)
{ 
    return cla3p_type(arith::getRe(v), arith::getIm(v));
}
...
/*-------------------------------------------------*/
/*-------------------------------------------------*/
TypeTraits<complex8_t>::cla3p_type TypeTraits<complex8_t>::toCla3pType(const complex8_t v)
{ 
    return cla3p_type(arith::getRe(v), arith::getIm(v));
}
